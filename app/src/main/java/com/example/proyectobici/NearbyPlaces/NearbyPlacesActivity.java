...
public class NearbyPlacesActivity extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button bSearch = findViewById(R.id.search);
        Button b1 = findViewById(R.id.place_1);
        Button b2 = findViewById(R.id.place_2);
        Button b3 = findViewById(R.id.place_3);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onClickBoton("place_1");
            }
        });
        b2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onClickBoton("place_2");
            }
        });
        b3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onClickBoton("place_3");
            }
        });
    }
    ...
    private String getUrl(double latitide, double longitude, String nearbyPlace)
    {
        ...
        googleURL.append("&key=" + "AIzaSyAS3IHks664Aw-QukFo73tWYUvRf_fWdkw");
